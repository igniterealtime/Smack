...
public class JingleContentElementTest extends SmackTestSuite {
    ...
    public void parserTest() throws Exception {
        ...
        assertEquals(xml, content1.toXML(new XmlEnvironment(null)).toString());
        ...
        assertEquals(xml, fromElement.getElement().toXML(new XmlEnvironment(null)).toString());
    }
    ...
    public void handleJingleRequestTest() {
        ...
        JingleElement contentModify = JingleElement.builder(StandardStanzaIdSource.DEFAULT.getNewStanzaId()).setAction(JingleAction.content_modify).setSessionId("session").build();
        ...
        JingleElement descriptionInfo = JingleElement.builder(StandardStanzaIdSource.DEFAULT.getNewStanzaId()).setAction(JingleAction.description_info).setSessionId("session").build();
