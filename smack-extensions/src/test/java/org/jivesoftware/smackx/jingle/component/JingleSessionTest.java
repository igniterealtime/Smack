...
public class JingleSessionTest extends SmackTestSuite {
    ...
    public void createSessionAcceptTest() throws XmppStringprepException {
        ...
        assertEquals(content.getElement().toXML(new XmlEnvironment(null)).toString(), contentElement.toXML(new XmlEnvironment(null)).toString());
        ...
        assertEquals(transport.getElement().toXML(new XmlEnvironment(null)).toString(), transportElement.toXML(new XmlEnvironment(null)).toString());
        ...
        assertEquals(description.getElement().toXML(new XmlEnvironment(null)).toString(), descriptionElement.toXML(new XmlEnvironment(null)).toString());
