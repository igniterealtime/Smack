...
public class JingleElementTest extends SmackTestSuite {
    ...
    public void createSessionTerminateDeclineTest() throws Exception {
        ...
        assertXmlSimilar(xml, terminate.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(terminate.getStanzaId()));
    ...
    public void createSessionTerminateSuccessTest() throws Exception {
        ...
        assertXmlSimilar(xml, success.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(success.getStanzaId()));
        assertNotNull(jingle);
        assertEquals(jingle.getAction(), JingleAction.session_terminate);
    ...
    public void createSessionTerminateBusyTest() throws Exception {
        ...
        assertXmlSimilar(xml, busy.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(busy.getStanzaId()));
        assertNotNull(jingle);
        assertEquals(jingle.getAction(), JingleAction.session_terminate);
    ...
    public void createSessionTerminateCancelTest() throws Exception {
        ...
        assertXmlSimilar(xml, cancel.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(cancel.getStanzaId()));
        assertNotNull(jingle);
        assertEquals(jingle.getAction(), JingleAction.session_terminate);
    ...
    public void createSessionTerminateUnsupportedTransportsTest() throws Exception {
        ...
        assertXmlSimilar(xml, unsupportedTransports.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(unsupportedTransports.getStanzaId()));
        assertNotNull(jingle);
        assertEquals(jingle.getAction(), JingleAction.session_terminate);
    ...
    public void createSessionTerminateUnsupportedApplicationsTest() throws Exception {
        ...
        assertXmlSimilar(xml, unsupportedApplications.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(unsupportedApplications.getStanzaId()));
        assertNotNull(jingle);
        assertEquals(jingle.getAction(), JingleAction.session_terminate);
    ...
    public void createSessionTerminateFailedTransportTest() throws IOException, SAXException {
        ...
        assertXmlSimilar(xml, failedTransport.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
    ...
    public void createSessionTerminateFailedApplicationTest() throws IOException, SAXException {
        ...
        assertXmlSimilar(xml, failedApplication.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
    ...
    public void createSessionPingTest() throws Exception {
        ...
        assertXmlSimilar(xml, ping.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
        JingleElement jingle = new JingleProvider().parse(TestUtils.getParser(jingleXML), StanzaBuilder.buildIqData(ping.getStanzaId()));
        assertNotNull(jingle);
    ...
    public void createTransportAcceptTest() throws IOException, SAXException {
        ...
        assertXmlSimilar(xml, transportAccept.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
    ...
    public void createTransportReplaceTest() throws IOException, SAXException {
        ...
        assertXmlSimilar(xml, transportReplace.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
    ...
    public void createErrorMalformedRequestTest() throws Exception {
        ...
        String xml =
                "<iq " +
                        ...
                        "</error>" +
                        "</iq>";
        assertXmlSimilar(xml, error.toXML(StreamOpen.CLIENT_NAMESPACE).toString());
    }
    ...
    private static JingleElement defaultJingle(FullJid recipient, String sessionId) {
