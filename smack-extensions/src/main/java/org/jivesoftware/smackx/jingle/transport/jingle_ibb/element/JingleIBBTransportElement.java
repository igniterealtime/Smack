...
public class JingleIBBTransportElement extends JingleContentTransportElement {
    ...
    public JingleIBBTransportElement() {
        this(StringUtils.randomString(24), null);
    }

    public JingleIBBTransportElement(Short blockSize) {
        this(StringUtils.randomString(24), blockSize);
    }

    public JingleIBBTransportElement(String streamId) {
        this(streamId, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        JingleIBBTransportElement otherIBBTransportElement = (JingleIBBTransportElement) other;
        return toXML().toString().contentEquals(otherIBBTransportElement.toXML().toString());
    }
