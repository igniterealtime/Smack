...
public final class JingleS5BTransportManager extends Manager implements JingleTransportManager {
    ...
    private static JingleElement createTransportInfo(JingleS5BTransport transport, XMPPConnection connection, JingleS5BTransportInfoElement info) {
    ...
    static JingleElement createCandidateUsed(JingleS5BTransport transport, XMPPConnection connection, JingleS5BTransportCandidate candidate) {
        return createTransportInfo(transport, connection, new JingleS5BTransportInfoElement.CandidateUsed(candidate.getCandidateId()));
    }

    static JingleElement createCandidateError(JingleS5BTransport transport, XMPPConnection connection) {
        return createTransportInfo(transport, connection, JingleS5BTransportInfoElement.CandidateError.INSTANCE);
    }

    static JingleElement createProxyError(JingleS5BTransport transport, XMPPConnection connection) {
        return createTransportInfo(transport, connection, JingleS5BTransportInfoElement.ProxyError.INSTANCE);
    }

    static JingleElement createCandidateActivated(JingleS5BTransport transport, XMPPConnection connection, JingleS5BTransportCandidate candidate) {
        return createTransportInfo(transport, connection, new JingleS5BTransportInfoElement.CandidateActivated(candidate.getCandidateId()));
    }
