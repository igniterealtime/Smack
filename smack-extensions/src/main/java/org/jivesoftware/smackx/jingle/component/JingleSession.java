...
public class JingleSession {
     ...
     * @throws UnsupportedSecurityException if an unknown/unsupported security element gets received.
     * @throws UnsupportedDescriptionException if an unknown/unsupported description element is received.
     * @throws UnsupportedTransportException if an unknown/unsupported transport element gets received.
     */
     ...
     * @return result.
     */
    private static IQ handleContentRemove(final JingleElement request) {
