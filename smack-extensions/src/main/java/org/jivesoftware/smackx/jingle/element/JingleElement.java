...
public final class JingleElement extends IQ {
    ...
    private JingleElement(Builder builder, String sessionId, JingleAction action, FullJid initiator, FullJid responder, JingleReasonElement reason,
    ...
    public static final class Builder extends IqBuilder<Builder, JingleElement> {
        private String sid;
        ...
        public JingleElement build() {
            return new JingleElement(this, sid, action, initiator, responder, reason, contents);
        }
    ...
    public static IQ createJingleErrorUnknownInitiator(JingleElement request) {
        ...
        return IQ.createErrorResponse(request, b.build());
    }
