...
public class Parameter extends AbstractElement {
    ...
    /**
     * <code>Parameter</code> default constructor use by DefaultElementProvider newInstance() etc.
    ...
    /**
     * Creates a new <code>Parameter</code>; required by DefaultElementProvider().
     *
    ...
    /**
     * Builder for Parameter. Use {@link AbstractElement.Builder#Builder(String)}
     * to obtain a new instance and {@link #build} to build the Parameter.
     */
    public static final class Builder extends AbstractElement.Builder<Parameter> {
         ...
         * with an empty value.
         * <a href="https://xmpp.org/extensions/xep-0294.html#element">...</a>
         *
