/**
 *
 * Copyright 2013-2025 Florian Schmaus.
 *
...
public class ExceptionLoggingCallback implements ParsingExceptionCallback {
    ...
    public void handleUnparsableStanza(UnparseableStanza unparsed) {
        LOGGER.log(Level.SEVERE, "Smack stanza parsing exception, stanza will be ignored. Content: '" + unparsed.getContent() + "'", unparsed.getParsingException());
    }
}
