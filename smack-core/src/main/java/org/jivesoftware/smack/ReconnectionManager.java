...
public class ReconnectionManager {
     ...
     * Also set the default connection policy to {@link ReconnectionPolicy#FIXED_DELAY}
     * 
    ...
    /**
     * Set the fixed delay in seconds between the reconnection attempts
     * Also set the connection policy to {@link ReconnectionPolicy#FIXED_DELAY}
     * 
     * @param fixedDelay Delay expressed in seconds 
     */
