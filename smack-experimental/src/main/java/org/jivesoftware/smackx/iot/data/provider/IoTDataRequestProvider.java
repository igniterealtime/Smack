...
public class IoTDataRequestProvider extends IqProvider<IoTDataRequest> {
    ...
    @Override
    public IoTDataRequest parse(XmlPullParser parser, int initialDepth, IqData iqData, XmlEnvironment xmlEnvironment, JxmppContext jxmppContext) throws IOException {
